    ...
    public partial class ForgotPassword : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(password))
            {
                ...
                msg.From = new MailAddress("phantomzone000@gmail.com");//dummy email add
                ...
                ntwd.UserName = "phantomzone000@gmail.com"; // dummy email add
                ntwd.Password = "!@#QWEasdzxc"; // password
